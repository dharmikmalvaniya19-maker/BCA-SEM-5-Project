...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (move_uploaded_file($tmp, $upload_path)) {
        ...
        $sql = "INSERT INTO products (brand_name, price, description, category, tag, image, stocks)
                VALUES ('$brand_name', '$price', '$description', '$category', '$tag', '$image', '$stocks')";
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .add-btn {
            background: #10b981; /* Primary action button color */
            color: #fff;
            padding: 12px 25px;
            border: none;
            border-radius: 6px;
...
<body>
    ...
    <input type="number" id="stocks" name="stocks" class="form-control" value="20" min="" required>
</div>
                <div class="form-group">
